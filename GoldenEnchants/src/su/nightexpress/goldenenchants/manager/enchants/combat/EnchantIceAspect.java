...
public class EnchantIceAspect extends ICombatEnchantPotionTemplate {
	
	public EnchantIceAspect(@NotNull GoldenEnchants plugin, @NotNull JYML cfg) {
		super(PotionEffectType.SLOW, plugin, cfg);
	}
