...
public class EnchantPoisonedArrows extends IEnchantPotionTemplate implements BowEnchant, CombatEnchant {
	
	private String arrowTrail;
	
	private static final String ARROW_META = "GOLDEN_ENCHANTS_POISONED_ARROW_META";
	
	public EnchantPoisonedArrows(@NotNull GoldenEnchants plugin, @NotNull JYML cfg) {
	...
	public void use(@NotNull EntityShootBowEvent e, @NotNull LivingEntity shooter,
		...
		ArrowTrailsTask.add((Projectile) p, this.arrowTrail);
